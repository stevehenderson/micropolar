...
var configs = [    
    ...
    {data: [{t: ['FOX', 'CNN', 'CBS', 'ABC', 'MSNBC', 'PBS', 'CSPAN', 'BBC'], r: [50, 29, 29, 37, 60, 39, 18, 9], name: 'Layer0', geometry: 'AreaChart', groupId: 0},
    ...
    {t: ['FOX', 'CNN', 'CBS', 'ABC', 'MSNBC', 'PBS', 'CSPAN', 'BBC'], r: [85, 43, 90, 37, 48, 31, 82, 66], name: 'Layer4', geometry: 'AreaChart', groupId: 0}],
